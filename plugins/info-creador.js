...
let name = await conn.getName(who)
  ...
  await sendContactArray(conn, m.chat, [
     [`${nomorown}`, `👑 Propietario`, `⏤͟͞ ⁞𝙈𝙞𝙯𝙪𝙠𝙞☄️⃟ᵀᵒⁿʸ✰⃔࿐ೄྀ`, dev, correo, `vn Venezuela`, `${global.yt}`, bio],
[`${conn.user.jid.split('@')[0]}`, `Es Una Bot 🍟`, `${packname}`, `📵 No Hacer Spam`, correo, `vn Venezuela`, md, biobot]
], m)
